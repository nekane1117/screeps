...
const behavior = (creep) => {
    ...
    switch (creep.memory.worked) {
        ...
        case ERR_NO_BODYPART:
            console.log(`${creep.name} harvest returns ${constants_1.RETURN_CODE_DECODER[creep.memory.worked.toString()]}`);
            creep.say(constants_1.RETURN_CODE_DECODER[creep.memory.worked.toString()]);
            break;
