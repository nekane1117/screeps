...
function behavior(source) {
    ...
    if (harvesters.length < source.room.memory.sources[source.id].spaces &&
        ...
        (_a = Object.values(Game.spawns)
            .find((spawn) => spawn.room.name === source.room.name && !spawn.spawning)) === null || _a === void 0 ? void 0 : _a.spawnCreep((0, utils_1.getBodyByCost)(constants_1.HARVESTER_BODY, source.room.energyAvailable), ["H", source.pos.x, source.pos.y, Game.time.toString()].join("_"), {
            memory: {
                role: "harvester",
